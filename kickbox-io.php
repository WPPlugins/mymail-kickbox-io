...
Plugin URI: http://rxa.li/mymail?utm_campaign=wporg&utm_source=MyMail+Kickbox.io+Integration
...
<?php
	...
	<div id="message" class="error">
	  <p>
	   <strong>Kickbox.io for MyMail</strong> requires the <a href="http://rxa.li/mymail?utm_campaign=wporg&utm_source=MyMail+Kickbox.io+Integration">MyMail Newsletter Plugin</a>, at least version <strong><?php echo MYMAIL_KICKBOXIO_REQUIRED_VERSION ?></strong>. Plugin deactivated.
	  </p>
	</div>
		<?php
	}
